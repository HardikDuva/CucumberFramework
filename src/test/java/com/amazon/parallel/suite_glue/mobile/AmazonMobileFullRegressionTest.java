...
public class AmazonMobileFullRegressionTest extends AbstractTestNGCucumberTests {

    /**
     * The name of the suite.
     */
    private final String suiteName = "mobile_full_regression";
    ...
    private void setVariablesForTest(
        ...
        info("I am setting the driver for this suite of tests");
